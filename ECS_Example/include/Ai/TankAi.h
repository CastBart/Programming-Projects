...
public:
   ...
   TankAi(std::vector<sf::CircleShape> const & obstacles, std::vector<sf::CircleShape> const & pathPoints, entityx::Entity::Id id);
...
private:
	...
	std::vector<sf::CircleShape> const & m_pathPoints;
